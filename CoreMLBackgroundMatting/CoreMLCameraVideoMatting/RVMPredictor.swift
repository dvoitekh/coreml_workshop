...
//    let model: RVM = try! RVM(configuration:  MLModelConfiguration())
//    var r1: MLMultiArray?
//    var r2: MLMultiArray?
//    var r3: MLMultiArray?
//    var r4: MLMultiArray?
    ...
    mutating func predict(src: CVPixelBuffer) {
        DispatchQueue.main.sync {
            self.sharedImage.fgr = UIImage(cgImage: src.toCGImage())
            self.sharedImage.pha = UIImage(cgImage: src.toCGImage())
        }
